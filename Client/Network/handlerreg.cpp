...
void HandlerReg::initialize() {
    ...
    MsgHandler* friendHistoryMsgHandler = new FriendHistoryMsgHandler(this);
    regHandler(MsgType::FRIEND_HISTORY_MSG, friendHistoryMsgHandler);

    MsgHandler* groupHistoryMsgHandler = new GroupHistoryMsgHandler(this);
    regHandler(MsgType::GROUP_HISTORY_MSG, groupHistoryMsgHandler);
}
