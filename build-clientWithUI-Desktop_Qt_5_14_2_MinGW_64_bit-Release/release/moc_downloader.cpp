...
#include <memory>
#include "../../Project Code/Client/Network/ResAssist/downloader.h"
...
QT_MOC_LITERAL(1, 11, 9), // "bufferImg"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "ChatMessage"
QT_MOC_LITERAL(4, 34, 3), // "msg"
QT_MOC_LITERAL(5, 38, 12), // "bufferAvatar"
QT_MOC_LITERAL(6, 51, 8), // "UserInfo"
QT_MOC_LITERAL(7, 60, 4) // "info"

    },
    "Downloader\0bufferImg\0\0ChatMessage\0msg\0"
    "bufferAvatar\0UserInfo\0info"
};
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bufferImg((*reinterpret_cast< ChatMessage(*)>(_a[1]))); break;
        case 1: _t->bufferAvatar((*reinterpret_cast< UserInfo(*)>(_a[1]))); break;
        default: ;
        }
    }
}
