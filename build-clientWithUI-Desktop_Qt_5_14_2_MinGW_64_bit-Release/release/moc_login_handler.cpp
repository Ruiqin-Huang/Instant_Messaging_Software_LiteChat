/****************************************************************************
** Meta object code from reading C++ file 'login_handler.h'
**
...
#include <memory>
#include "../../Project Code/Client/Network/Handlers/login_handler.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'login_handler.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 14), // "sigLoginFailed"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 18), // "sigLoginSuccessful"
QT_MOC_LITERAL(4, 48, 8), // "UserInfo"
QT_MOC_LITERAL(5, 57, 4) // "info"

    },
    "LoginHandler\0sigLoginFailed\0\0"
    "sigLoginSuccessful\0UserInfo\0info"
};
...
void LoginHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sigLoginSuccessful((*reinterpret_cast< UserInfo(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginHandler::sigLoginFailed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginHandler::*)(UserInfo );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginHandler::sigLoginSuccessful)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginHandler::sigLoginFailed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void LoginHandler::sigLoginSuccessful(UserInfo _t1)
{
